...
module testbench;
    ...
    task axi_read(
        ...
        begin
            ...
            if (rresp == 2'b00 && rid == id && rlast) begin
                $display("? Read successful - Data=0x%08x", read_data);
            end else begin
    ...
    initial begin
        ...
        // Test 1: Simple Write
        axi_write(32'h1000, 32'hDEADBEEF, 4'h1);
        repeat(10) @(posedge clk);
        
        // Test 2: Simple Read (same address)
        axi_read(32'h1000, 4'h2, read_data);
        repeat(10) @(posedge clk);
        ...
        axi_write(32'h2000, 32'h12345678, 4'h3);
        repeat(10) @(posedge clk);
        axi_write(32'h3000, 32'h87654321, 4'h4);
        repeat(10) @(posedge clk);
        
        // Test 4: Read back the multiple writes
        axi_read(32'h2000, 4'h5, read_data);
        repeat(10) @(posedge clk);
        axi_read(32'h3000, 4'h6, read_data);
        repeat(10) @(posedge clk);
